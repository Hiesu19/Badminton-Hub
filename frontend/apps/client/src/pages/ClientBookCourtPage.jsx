...
import CourtPriceDialog from '../components/CourtPriceDialog.jsx';
...
const buildBookingItemsFromSelectedSlots = (selectedSlots, priceMatrix) => {
    ...
    Object.entries(groups).forEach(([date, courts]) => {
        ...
        const dayOfWeek = Number.isNaN(jsDate.getTime())
            ? null
            : jsDate.getDay(); // 0=CN
...
const ClientBookCourtPage = () => {
    ...
    const handleConfirmBooking = async ({ note }) => {
        ...
        try {
            const booking = await createBooking(finalPayload);
            console.log('Đặt sân thành công:', booking);
            ...
            // Load lại dữ liệu giá + lịch để phản ánh các slot vừa đặt
            if (courtIdParam) {
                try {
                    const [matrix, calendar] = await Promise.all([
                        fetchPublicCourtPriceMatrix(courtIdParam),
                    ...
                    console.error(
                        'Không thể load lại dữ liệu sau khi đặt sân:',
                        reloadError,
                    );
                }
            }
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            ...
                            sx={{ color: '#4b5563', fontSize: 12 }}
                        >
                            - Vui lòng đặt liền, không để khoảng trống giữa các
                            ca.
                        </Typography>
                        <Typography
                            variant="body2"
                ...
                <BookingNoteDialog
                    ...
                    summary={
                        pendingPayload && {
                            date: selectedDate,
                            totalPrice: pendingPayload.totalPrice,
